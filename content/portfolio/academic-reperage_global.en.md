...
showonlyimage = true
draft = false
image = "https://res.cloudinary.com/f0prauim/image/upload/v1786369182/reperage_Fig13-viewer-restitution.png"
...
{{< remote-img-with-caption src="https://res.cloudinary.com/f0prauim/image/upload/v1786369182/reperage_150_figure-4moments.png" alt="Portrait" height="200" caption="Four facet for the restitution of the arch and it's remains trajectory: (a) archeological anastylosis, (b) photogrammetry and 3d modelling, (c) voussoirs identification, (d) an hybrid solution, the interplay of mathematical optimisation and anastylosis. [(A. Kommanda/LRMH/RNDP, 2021), (Gros, 2023), (MAP/CNRS/MC, 2022), (Gros, 2022)]" >}}
...
{{< remote-img-with-caption src="https://res.cloudinary.com/f0prauim/image/upload/v1786369182/reperage-humanistica.png" alt="Portrait" height="200" caption="A diagrammatic extract from the CIDOC CRM mapping of the voussoirs N1A and N320' informations (Guillem et al., 2023)" >}}
